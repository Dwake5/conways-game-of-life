...
const stillLifes = () => {
    ...
    let alive = [
        [1,1],[1,2],[2,1],[2,2],
        [1,8],[2,7],[3,7],[4,8],[2,9],[3,9],
        [5,2],[6,3],[7,4],[6,1],[7,1],[8,2],[8,3],
        [14,4],[15,4],[14,5],[15,6],[16,5],
        [9,8],[8,9],[9,10],[10,9]
...
const oscillator = () => {
    ...
    let alive = [
        [3,2],[3,3],[3,4],
        [10,2],[11,2],[12,2],[9,3],[10,3],[11,3],
        [17,2],[18,2],[18,3],[17,3],[19,4],[20,4],[20,5],[19,5],
        [4, 18],[4, 19],[4, 20],[4, 24],[4, 25],[4, 26],[6, 16],[6, 21],[6, 23],[6, 28],[7, 16],[7, 21],[7, 23],[7, 28],[8, 16],[8, 21],[8, 23],[8, 28], [9, 18], [9, 19],  [9, 20],  [9, 24],  [9, 25],[9, 26], [11, 18], [11, 19], [11, 20], [11, 24], [11, 25], [11, 26], [12, 16], [12, 21], [12, 23], [12, 28], [13, 16], [13, 21], [13, 23], [13, 28], [14, 16],
        [14, 21], [14, 23], [14, 28], [16, 18], [16, 19], [16, 20], [16, 24], [16, 25], [16, 26], [37, 14],[37, 19],[38, 12],[38, 13],[38, 15],[38, 16],[38, 17],[38, 18],[38, 20],[38, 21],[39, 14],[39, 19],
    ]
    populateCells(alive)
}

const gliders = () => {
    [[5, 15],[6, 16],[7, 3] ,[7, 14],[7, 15],[7, 16],[8, 4] ,[9, 2],[9, 3],[9, 4],[17, 4],[18, 5], [19, 3], [19, 4], [19, 5], [20, 11], [21, 12], [22, 10], [22, 11], [22, 12], [34, 4], [35, 5], [36, 3], [36, 4], [36, 5]]
}

const lightWeight = () => {
    [[3, 4],[3, 5],[4, 3],[4, 4],[4, 5],[5, 3],[5, 4],[5, 6],[6, 4],[6, 5],[6, 6],[7, 5],[10, 18],[10, 19],[11, 17],[11, 18],[11, 19],[12, 17],[12, 18],[12, 20],[13, 18],[13, 19],[13, 20],[14, 6],[14, 7],[14, 19],[15, 5],[15, 6],[15, 7],[16, 5],[16, 6],[16, 8],[17, 6],[17, 7],[17, 8],[18, 7],[27, 7],[27, 8],[28, 6],[28, 7],[28, 8],[29, 6],[29, 7],[29, 9],[30, 7],[30, 8],[30, 9],[31, 8]]
}

const mediumWeight = () => {
    [[4, 6],[4, 7],[5, 5],[5, 6],[5, 7],[6, 5],[6, 6],[6, 7],[7, 5],[7, 6],[7, 8],[8, 6],[8, 7],[8, 8],[9, 7],[10, 18],[10, 19],[11, 17],[11, 18],[11, 19],[12, 17],[12, 18],[12, 19],[13, 17],[13, 18],[13, 20],[14, 18],[14, 19],[14, 20],[15, 19],[24, 10],[24, 11],[25, 9],[25, 10],[25, 11],[26, 9],[26, 10],[26, 11],[27, 9],[27, 10],[27, 12],[28, 10],[28, 11],[28, 12],[29, 11]]
}

const heavyWeight = () => {
    [[6, 20],[6, 21],[7, 7],[7, 8],[7, 20],[7, 21],[7, 22],[8, 7],[8, 8],[8, 9],[8, 20],[8, 21],[8, 22],[9, 7],[9, 8],[9, 9],[9, 20],[9, 21],[9, 22],[10, 7],[10, 8],[10, 9],[10, 19],[10, 21],[10, 22],[11, 6],[11, 8],[11, 9],[11, 19],[11, 20],[11, 21],[12, 6],[12, 7],[12, 8],[12, 20],[13, 7]]
}

const gospelGliderGun = () => {
    [[3, 7],[3, 8],[4, 7],[4, 8],[13, 7],[13, 8],[13, 9],[14, 6],[14, 10],[15, 5],[15, 11],[16, 5],[16, 11],[17, 8],[18, 6],[18, 10],[19, 7],[19, 8],[19, 9],[20, 8],[23, 5],[23, 6],[23, 7],[24, 5],[24, 6],[24, 7],[25, 4],[25, 8],[27, 3],[27, 4],[27, 8],[27, 9],[37, 5],[37, 6],[38, 5],[38, 6]]
}
